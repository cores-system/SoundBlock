...
namespace CSCore.CoreAudioAPI
{
    ...
    public class AudioSessionManager2 : AudioSessionManager
    {
        ...
        public AudioSessionEnumerator GetSessionEnumerator()
        {
            ...
            var res = GetSessionEnumeratorNative(out sessionEnumerator);

            if (res == -1 || sessionEnumerator == null || sessionEnumerator.IsComError || sessionEnumerator.IsError)
                return new AudioSessionEnumerator();
